const About = () => {
    return (
        <>
            ...
            <p>Esse projeto foi feito para fins acadêmicos, como atividade avaliativa.</p>
            <p>A ideia é criar um jogo de cartas, onde cada carta é um gato, e cada gato tem atributos diferentes.</p>
